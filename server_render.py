# Render-ready FastAPI server (robust + minimal deps)
import os
...
app = FastAPI(title="Lotto Predictor", version="1.0.0")
...
# ---- Lotto helpers (official JSON endpoint) ----
...
def get_latest_round():
    # Binary search around a safe upper bound to find latest success
    lo, hi = 1, 1500
    while lo < hi:
        mid = (lo + hi + 1) // 2
